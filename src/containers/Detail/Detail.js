    ...
    return (
      <div className="detail">
        ...
        <div className="detailFooter">
          <i
            className={this.state.flag2 == 1 ? "goBack iconfont icon-fanhui11" : (this.state.flag2 == 2 ? "goBack iconfont icon-suijibofang" : "goBack iconfont icon-danquxunhuan")}
            ...
            <i className="playLeft iconfont icon-zuobofang"
          ...
          <i className={this.state.flag1 ? "curMusicPlay iconfont icon-bofang1" : "curMusicPlay iconfont icon-bofang11"}
            ...
            <i className="playRight iconfont icon-youbofang"
